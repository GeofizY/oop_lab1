            ...
            <div>
                ...
                <ul>
                    <li>
                        ...
                        <a href='https:/ / msdn.microsoft.com / en - us / library / 67e f8sbd.aspx '>
                            C#
                        </a>{" "}
                ...
                <ul>
                    <li>
                        {" "}
                        <strong> Client - side navigation </strong>. For
                        example, click <em>Counter</em> then <em> Back </em> to
                        return here.
                    </li>
                    <li>
                        {" "}
                ...
                <p>
                    {" "}
                    The <code> ClientApp </code> subdirectory is a standard
                    React application based on the <code>create-react-app</code>{" "}
                    template.If you open a command prompt in that directory, you
                    can run <code> npm </code> commands such as{" "}
